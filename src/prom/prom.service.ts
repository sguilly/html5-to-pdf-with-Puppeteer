...
export class PromService implements MetricsInterface {
  ...
  constructor() {
    ...
    this.requestDurationMs = new promClient.Histogram({
      name: 'html5_to_pdf_with_Puppeteer_request_duration_ms',
